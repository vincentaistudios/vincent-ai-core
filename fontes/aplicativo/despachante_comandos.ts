import { ContextoComando } from './comandos/tipos.js';
...
import {
  executarCorteAudio,
  executarVelocidadeAudio,
  executarReversoAudio,
  executarBassBoost,
  executarCalculadora,
  executarConversor,
  executarGerarQR,
  ...
  executarLyrics,
  executarSticker,
} from './comandos/ferramentas.js';

/**
 * Função principal que recebe mensagens de comando e despacha para a lógica correta.
 */
export async function lidarComComando(ctx: ContextoComando): Promise<boolean> {
  ...
  switch (comando) {
    ...
    case 'bc': case 'transmissao': case 'broadcast':
    ...
    case 'painel_reiniciar': case 'painel_limpar':
